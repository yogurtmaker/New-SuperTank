...
public class ExplosionEffect extends AbstractControl {
    ...
    private int state = 0;
    private Node explosionEffect = new Node("explosionFX"), parent;
    ...
    public ExplosionEffect(SimpleApplication sa, Node parent, Vector3f location) {
        this.sa = sa;
        this.parent = parent;
        ...
        createDebris();
        createShockwave();
        explosionEffect.addControl(this);
        explosionEffect.setLocalScale(1.5f);
        sa.getRenderManager().preloadScene(explosionEffect);
        parent.attachChild(explosionEffect);
    }
    ...
    private void createFlame() {
        ...
        flame.setImagesX(2);
        flame.setImagesY(2);
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/flame.png"));
    ...
    private void createFlash() {
        ...
        flash.setImagesY(2);
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/flash.png"));
        mat.setBoolean("PointSprite", POINT_SPRITE);
    ...
    private void createRoundSpark() {
        ...
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/roundspark.png"));
        mat.setBoolean("PointSprite", POINT_SPRITE);
    ...
    private void createSpark() {
        ...
        spark.setImagesY(1);
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/spark.png"));
    ...
    private void createSmokeTrail() {
        ...
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/smoketrail.png"));
    ...
    private void createDebris() {
        ...
        debris.setImagesY(3);
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/Debris.png"));
    ...
    private void createShockwave() {
        ...
        Material mat = new Material(sa.getAssetManager(), "Common/MatDefs/Misc/Particle.j3md");
        mat.setTexture("Texture", sa.getAssetManager().loadTexture("Effects/Explosion/shockwave.png"));
    ...
    protected void controlUpdate(float tpf) {
        ...
        if (time > 4 / speed && state == 2) {
            ...
            parent.detachChild(explosionEffect);
        }
    }
